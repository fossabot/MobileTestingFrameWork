...
public class DeviceApi {
    ...
    public DeviceApi(MDFService mdfService) {
    ...
    public boolean connectDevice(String deviceSerial) {
        Request request = new Request.Builder()
                .addHeader("Authorization", "Bearer " + mdfService.getAuthToken())
                .url(mdfService.getMdfUrl() + "devices/" + deviceSerial)
                .build();
        Response response;
        try {
            ...
            throw new IllegalArgumentException("MDF service is unreachable", e);
        }
    }
    ...
    private boolean addDeviceToUser(String deviceSerial) {
        ...
        Request request = new Request.Builder()
                .addHeader("Authorization", "Bearer " + mdfService.getAuthToken())
                .url(mdfService.getMdfUrl() + "user/devices")
                .post(requestBody)
                .build();
        Response response;
        try {
    ...
    public boolean releaseDevice(String deviceSerial) {
        Request request = new Request.Builder()
                .addHeader("Authorization", "Bearer " + mdfService.getAuthToken())
                .url(mdfService.getMdfUrl() + "user/devices/" + deviceSerial)
                .delete()
                .build();
        Response response;
        try {
